...
from tools import pdf_analysis, web_search

# Merge every tool module's declarations and registries into the two
# structures the agent loop dispatches on. Adding a tool is now just a
# matter of listing its module here.
TOOL_MODULES = [web_search, pdf_analysis]

TOOL_DECLARATIONS = [
    declaration
    for module in TOOL_MODULES
    for declaration in module.TOOL_DECLARATIONS
]

TOOL_REGISTRY = {
    name: function
    for module in TOOL_MODULES
    for name, function in module.TOOL_REGISTRY.items()
}
